...
# Export the `nvm` shell function to make it visible to a shell's children.
# This fixes the problem of a non-login shell not being able to use `nvm` when
# it's sourced in the login shell through `~/.profile` et al.
export -f nvm_is_zsh
export -f nvm_stdout_is_terminal
export -f nvm_echo
export -f nvm_cd
export -f nvm_err
export -f nvm_grep
export -f nvm_has
export -f nvm_has_non_aliased
export -f nvm_is_alias
export -f nvm_command_info
export -f nvm_has_colors
export -f nvm_curl_libz_support
export -f nvm_curl_use_compression
export -f nvm_get_latest
export -f nvm_download
export -f nvm_has_system_node
export -f nvm_has_system_iojs
export -f nvm_is_version_installed
export -f nvm_print_npm_version
export -f nvm_install_latest_npm
export -f nvm_tree_contains_path
export -f nvm_find_up
export -f nvm_find_nvmrc
export -f nvm_rc_version
export -f nvm_clang_version
export -f nvm_curl_version
...
export -f nvm_change_path
export -f nvm_binary_available
export -f nvm_print_formatted_alias
export -f nvm_print_alias_path
export -f nvm_print_default_alias
export -f nvm_make_alias
export -f nvm_list_aliases
export -f nvm_alias
...
export -f nvm_ls_remote_index_tab
export -f nvm_get_checksum_alg
export -f nvm_compute_checksum
export -f nvm_compare_checksum
export -f nvm_get_checksum
...
export -f nvm_get_minor_version
export -f nvm_ensure_default_set
export -f nvm_is_merged_node_version
export -f nvm_get_mirror
export -f nvm_install_binary
export -f nvm_get_download_slug
export -f nvm_download_artifact
export -f nvm_get_make_jobs
export -f nvm_install_source
export -f nvm_use_if_needed
export -f nvm_install_npm_if_needed
export -f nvm_match_version
export -f nvm_npm_global_modules
export -f nvm_die_on_prefix
export -f nvm_has_solaris_binary
export -f nvm_sanitize_path
export -f nvm_is_natural_num
export -f nvm_check_file_permissions
export -f nvm_cache_dir
export -f nvm
export -f nvm_get_default_packages
export -f nvm_install_default_packages
export -f nvm_supports_source_options
export -f nvm_supports_xz
export -f nvm_auto
export -f nvm_process_parameters
